...
rms_demeaned = @(INPUT,OPTION) rms(INPUT - mean(INPUT,'omitnan'),OPTION);
...
RMSDd_velmag_SWOTg_HFRunfiltered = nan(size(NORCAL.HFR.LON));
...
RMSDd_velmag_SWOTcg_HFR = nan(size(NORCAL.HFR.LON));
...
RMSDd_velmag_SWOTcg_HFRunfiltered = nan(size(NORCAL.HFR.LON));
    ...
    for jj = 1:size(Ug_SWOT_HFRgrid_all,2)
        ...
        if sum(isfinite(Ug_SWOT_HFRgrid_all(ii,jj,:)))/numel(Ug_SWOT_HFRgrid_all(ii,jj,:)) > CUTOFF & ...
           sum(isfinite(U_rot_filtered_SWOTtimes(ii,jj,:)))/numel(U_rot_filtered_SWOTtimes(ii,jj,:)) > CUTOFF
            ...
            RMSD_U_SWOTg_HFR(ii,jj) = rms(Ug_SWOT_HFRgrid_all(ii,jj,:) - U_rot_filtered_SWOTtimes(ii,jj,:),'omitnan');
            ...
            RMSD_V_SWOTg_HFR(ii,jj) = rms(Vg_SWOT_HFRgrid_all(ii,jj,:) - V_rot_filtered_SWOTtimes(ii,jj,:),'omitnan');
            ...
            RMSDd_velmag_SWOTg_HFR(ii,jj) = rms_demeaned( [Ug_SWOT_HFRgrid_all(     ii,jj,:) + 1i*Vg_SWOT_HFRgrid_all(     ii,jj,:)] - ...
                                                [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');%$#
            ...
            RMSD_velmag_SWOTg_HFRunfiltered(ii,jj) = rms( [Ug_SWOT_HFRgrid_all(       ii,jj,:) + 1i*Vg_SWOT_HFRgrid_all(       ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_SWOTg_HFRunfiltered(ii,jj) = rms_demeaned( [Ug_SWOT_HFRgrid_all(       ii,jj,:) + 1i*Vg_SWOT_HFRgrid_all(       ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
        else
        end
        % Cyclogeostrophy
        if sum(isfinite(Ucg_SWOT_HFRgrid_all(ii,jj,:)))/numel(Ucg_SWOT_HFRgrid_all(ii,jj,:)) > CUTOFF & ...
           sum(isfinite(U_rot_filtered_SWOTtimes(ii,jj,:)))/numel(U_rot_filtered_SWOTtimes(ii,jj,:)) > CUTOFF
            ...
            RMSD_velmag_SWOTcg_HFR(ii,jj) = rms([Ucg_SWOT_HFRgrid_all(    ii,jj,:) + 1i*Vcg_SWOT_HFRgrid_all(    ii,jj,:)] - ...
                                                [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_SWOTcg_HFR(ii,jj) = rms_demeaned([Ucg_SWOT_HFRgrid_all(    ii,jj,:) + 1i*Vcg_SWOT_HFRgrid_all(    ii,jj,:)] - ...
                                                [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');
            ...
            RMSD_velmag_SWOTcg_HFRunfiltered(ii,jj) = rms([Ucg_SWOT_HFRgrid_all(      ii,jj,:) + 1i*Vcg_SWOT_HFRgrid_all(      ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_SWOTcg_HFRunfiltered(ii,jj) = rms_demeaned([Ucg_SWOT_HFRgrid_all(      ii,jj,:) + 1i*Vcg_SWOT_HFRgrid_all(      ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
        else
        end
    end
...
%% RMSD and correlation between DUACS8 geostrophic velocity to HFR velocity

% DUACS 1/4 degree
% Correlation
CUTOFF = 0.8; % minimum fraction of good data required to perform calculation
U_DUACS4g_HFR_Corr_R = nan(size(NORCAL.HFR.LON));
U_DUACS4g_HFR_Corr_P = nan(size(NORCAL.HFR.LON));
V_DUACS4g_HFR_Corr_R = nan(size(NORCAL.HFR.LON));
V_DUACS4g_HFR_Corr_P = nan(size(NORCAL.HFR.LON));
RMSD_velmag_DUACS4g_HFR = nan(size(NORCAL.HFR.LON));
RMSDd_velmag_DUACS4g_HFR = nan(size(NORCAL.HFR.LON));

U_DUACS4g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON));
U_DUACS4g_HFRunfiltered_Corr_P = nan(size(NORCAL.HFR.LON));
V_DUACS4g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON));
V_DUACS4g_HFRunfiltered_Corr_P = nan(size(NORCAL.HFR.LON));
RMSD_velmag_DUACS4g_HFRunfiltered = nan(size(NORCAL.HFR.LON));
RMSDd_velmag_DUACS4g_HFRunfiltered = nan(size(NORCAL.HFR.LON));

W_DUACS4g_HFR_Corr_R = nan(size(NORCAL.HFR.LON)); % Complex (no p-values possible with them)
W_DUACS4g_HFR_Corr_angle = nan(size(NORCAL.HFR.LON));

W_DUACS4g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON)); % Complex (no p-values possible with them)
W_DUACS4g_HFRunfiltered_Corr_angle = nan(size(NORCAL.HFR.LON));

SWOT_TIMES = [];
for ii = 1:length(NORCAL.SWOT.mean_time)
    if isfinite(NORCAL.SWOT.mean_time(ii))
        SWOT_TIMES = [SWOT_TIMES ; dsearchn(DUACS_4_struct.time, NORCAL.SWOT.mean_time(ii))];
    else
        SWOT_TIMES = [SWOT_TIMES ; NaN];
    end
end
SWOT_TIMES_ = SWOT_TIMES;
for ii = 1:length(SWOT_TIMES)
    if ~isfinite(SWOT_TIMES(ii))
        SWOT_TIMES_(ii) = SWOT_TIMES(ii - 1) + 1;
    end
end
Ug_DUACS4_HFRgrid_all = DUACS_4_struct.U_geostr_HFRgrid(:,:,SWOT_TIMES_);
Vg_DUACS4_HFRgrid_all = DUACS_4_struct.V_geostr_HFRgrid(:,:,SWOT_TIMES_);
for ii = 1:size(Ug_DUACS4_HFRgrid_all,3)
    if ~isfinite(SWOT_TIMES(ii))
        Ug_DUACS4_HFRgrid_all(:,:,ii) = NaN*Ug_DUACS4_HFRgrid_all(:,:,ii);
        Vg_DUACS4_HFRgrid_all(:,:,ii) = NaN*Vg_DUACS4_HFRgrid_all(:,:,ii);
    end
end

tic
for ii = 1:size(Ug_DUACS4_HFRgrid_all,1)
    for jj = 1:size(Ug_DUACS4_HFRgrid_all,2)
        % Geostrophy
        if sum(isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)))/numel(Ug_DUACS4_HFRgrid_all(ii,jj,:)) > CUTOFF & ...
           sum(isfinite(U_rot_filtered_SWOTtimes(ii,jj,:)))/numel(U_rot_filtered_SWOTtimes(ii,jj,:)) > CUTOFF
            % Ug vs. filtered HFR
            [RR,PP] = corrcoef(Ug_DUACS4_HFRgrid_all(     ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               U_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:))));
            U_DUACS4g_HFR_Corr_R(ii,jj) = RR(1,2);
            U_DUACS4g_HFR_Corr_P(ii,jj) = PP(1,2);

            % Ug vs. unfiltered HFR
            [RR,PP] = corrcoef(Ug_DUACS4_HFRgrid_all(     ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               U_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:))));
            U_DUACS4g_HFRunfiltered_Corr_R(ii,jj) = RR(1,2);
            U_DUACS4g_HFRunfiltered_Corr_P(ii,jj) = PP(1,2);

            % Vg vs. filtered HFR
            [RR,PP] = corrcoef(Vg_DUACS4_HFRgrid_all(     ii,jj,isfinite(Vg_DUACS4_HFRgrid_all(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               V_rot_filtered_SWOTtimes(ii,jj,isfinite(Vg_DUACS4_HFRgrid_all(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))));
            V_DUACS4g_HFR_Corr_R(ii,jj) = RR(1,2);
            V_DUACS4g_HFR_Corr_P(ii,jj) = PP(1,2);
            
            % Vg vs. unfiltered HFR
            [RR,PP] = corrcoef(Vg_DUACS4_HFRgrid_all(     ii,jj,isfinite(Vg_DUACS4_HFRgrid_all(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               V_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Vg_DUACS4_HFRgrid_all(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))));
            V_DUACS4g_HFRunfiltered_Corr_R(ii,jj) = RR(1,2);
            V_DUACS4g_HFRunfiltered_Corr_P(ii,jj) = PP(1,2);

            % Ug+iVg vs. filtered HFR
            [RR] = corrcoef(   Ug_DUACS4_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))) + ...
                            1i*Vg_DUACS4_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               U_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))) + ...
                            1i*V_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))));
            W_DUACS4g_HFR_Corr_R(ii,jj) = abs(RR(1,2));
            W_DUACS4g_HFR_Corr_angle(ii,jj) = angle(RR(1,2))*180/pi;
            RMSD_velmag_DUACS4g_HFR(ii,jj) = rms( [Ug_DUACS4_HFRgrid_all(   ii,jj,:) + 1i*Vg_DUACS4_HFRgrid_all(ii,jj,:)] - ...
                                                  [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');%$#
            RMSDd_velmag_DUACS4g_HFR(ii,jj) = rms_demeaned( [Ug_DUACS4_HFRgrid_all(   ii,jj,:) + 1i*Vg_DUACS4_HFRgrid_all(ii,jj,:)] - ...
                                                  [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');%$#

            % Ug+iVg vs. unfiltered HFR
            [RR] = corrcoef(   Ug_DUACS4_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))) + ...
                            1i*Vg_DUACS4_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               U_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))) + ...
                            1i*V_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS4_HFRgrid_all(ii,jj,:)+Vg_DUACS4_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))));
            W_DUACS4g_HFRunfiltered_Corr_R(ii,jj) = abs(RR(1,2));
            W_DUACS4g_HFRunfiltered_Corr_angle(ii,jj) = angle(RR(1,2))*180/pi;
            RMSD_velmag_DUACS4g_HFRunfiltered(ii,jj) = rms( [Ug_DUACS4_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS4_HFRgrid_all(ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_DUACS4g_HFRunfiltered(ii,jj) = rms_demeaned( [Ug_DUACS4_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS4_HFRgrid_all(ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
        else
        end
    end
    disp(100*ii/size(Ug_DUACS4_HFRgrid_all,1))
end
toc
...
% Correlation
CUTOFF = 0.8; % minimum fraction of good data required to perform calculation
U_DUACS8g_HFR_Corr_R = nan(size(NORCAL.HFR.LON));
U_DUACS8g_HFR_Corr_P = nan(size(NORCAL.HFR.LON));
V_DUACS8g_HFR_Corr_R = nan(size(NORCAL.HFR.LON));
V_DUACS8g_HFR_Corr_P = nan(size(NORCAL.HFR.LON));
RMSD_velmag_DUACS8g_HFR = nan(size(NORCAL.HFR.LON));
RMSDd_velmag_DUACS8g_HFR = nan(size(NORCAL.HFR.LON));

U_DUACS8g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON));
U_DUACS8g_HFRunfiltered_Corr_P = nan(size(NORCAL.HFR.LON));
V_DUACS8g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON));
V_DUACS8g_HFRunfiltered_Corr_P = nan(size(NORCAL.HFR.LON));
RMSD_velmag_DUACS8g_HFRunfiltered = nan(size(NORCAL.HFR.LON));
RMSDd_velmag_DUACS8g_HFRunfiltered = nan(size(NORCAL.HFR.LON));

W_DUACS8g_HFR_Corr_R = nan(size(NORCAL.HFR.LON)); % Complex (no p-values possible with them)
W_DUACS8g_HFR_Corr_angle = nan(size(NORCAL.HFR.LON));

W_DUACS8g_HFRunfiltered_Corr_R = nan(size(NORCAL.HFR.LON)); % Complex (no p-values possible with them)
W_DUACS8g_HFRunfiltered_Corr_angle = nan(size(NORCAL.HFR.LON));

SWOT_TIMES = [];
for ii = 1:length(NORCAL.SWOT.mean_time)
    if isfinite(NORCAL.SWOT.mean_time(ii))
        SWOT_TIMES = [SWOT_TIMES ; dsearchn(DUACS_8_struct.time, NORCAL.SWOT.mean_time(ii))];
    else
        SWOT_TIMES = [SWOT_TIMES ; NaN];
    end
end
...
Ug_DUACS8_HFRgrid_all = DUACS_8_struct.U_geostr_HFRgrid(:,:,SWOT_TIMES_);
Vg_DUACS8_HFRgrid_all = DUACS_8_struct.V_geostr_HFRgrid(:,:,SWOT_TIMES_);
for ii = 1:size(Ug_DUACS8_HFRgrid_all,3)
    if ~isfinite(SWOT_TIMES(ii))
        Ug_DUACS8_HFRgrid_all(:,:,ii) = NaN*Ug_DUACS8_HFRgrid_all(:,:,ii);
        Vg_DUACS8_HFRgrid_all(:,:,ii) = NaN*Vg_DUACS8_HFRgrid_all(:,:,ii);
    end
end

tic
for ii = 1:size(Ug_DUACS8_HFRgrid_all,1)
    for jj = 1:size(Ug_DUACS8_HFRgrid_all,2)
        % Geostrophy
        if sum(isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)))/numel(Ug_DUACS8_HFRgrid_all(ii,jj,:)) > CUTOFF & ...
           sum(isfinite(U_rot_filtered_SWOTtimes(ii,jj,:)))/numel(U_rot_filtered_SWOTtimes(ii,jj,:)) > CUTOFF
            % Ug vs. filtered HFR
            [RR,PP] = corrcoef(Ug_DUACS8_HFRgrid_all(     ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               U_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:))));
            U_DUACS8g_HFR_Corr_R(ii,jj) = RR(1,2);
            U_DUACS8g_HFR_Corr_P(ii,jj) = PP(1,2);

            % Ug vs. unfiltered HFR
            [RR,PP] = corrcoef(Ug_DUACS8_HFRgrid_all(     ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               U_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:))));
            U_DUACS8g_HFRunfiltered_Corr_R(ii,jj) = RR(1,2);
            U_DUACS8g_HFRunfiltered_Corr_P(ii,jj) = PP(1,2);

            % Vg vs. filtered HFR
            [RR,PP] = corrcoef(Vg_DUACS8_HFRgrid_all(     ii,jj,isfinite(Vg_DUACS8_HFRgrid_all(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               V_rot_filtered_SWOTtimes(ii,jj,isfinite(Vg_DUACS8_HFRgrid_all(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))));
            V_DUACS8g_HFR_Corr_R(ii,jj) = RR(1,2);
            V_DUACS8g_HFR_Corr_P(ii,jj) = PP(1,2);
            
            % Vg vs. unfiltered HFR
            [RR,PP] = corrcoef(Vg_DUACS8_HFRgrid_all(     ii,jj,isfinite(Vg_DUACS8_HFRgrid_all(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               V_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Vg_DUACS8_HFRgrid_all(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))));
            V_DUACS8g_HFRunfiltered_Corr_R(ii,jj) = RR(1,2);
            V_DUACS8g_HFRunfiltered_Corr_P(ii,jj) = PP(1,2);

            % Ug+iVg vs. filtered HFR
            [RR] = corrcoef(   Ug_DUACS8_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))) + ...
                            1i*Vg_DUACS8_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))), ...
                               U_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))) + ...
                            1i*V_rot_filtered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_filtered_SWOTtimes(ii,jj,:)+V_rot_filtered_SWOTtimes(ii,jj,:))));
            W_DUACS8g_HFR_Corr_R(ii,jj) = abs(RR(1,2));
            W_DUACS8g_HFR_Corr_angle(ii,jj) = angle(RR(1,2))*180/pi;
            RMSD_velmag_DUACS8g_HFR(ii,jj) = rms( [Ug_DUACS8_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS8_HFRgrid_all(ii,jj,:)] - ...
                                                [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_DUACS8g_HFR(ii,jj) = rms_demeaned( [Ug_DUACS8_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS8_HFRgrid_all(ii,jj,:)] - ...
                                                [U_rot_filtered_SWOTtimes(ii,jj,:) + 1i*V_rot_filtered_SWOTtimes(ii,jj,:)],'omitnan');

            % Ug+iVg vs. unfiltered HFR
            [RR] = corrcoef(   Ug_DUACS8_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))) + ...
                            1i*Vg_DUACS8_HFRgrid_all(  ii,jj,isfinite(   Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))), ...
                               U_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))) + ...
                            1i*V_rot_unfiltered_SWOTtimes(ii,jj,isfinite(Ug_DUACS8_HFRgrid_all(ii,jj,:)+Vg_DUACS8_HFRgrid_all(ii,jj,:)+U_rot_unfiltered_SWOTtimes(ii,jj,:)+V_rot_unfiltered_SWOTtimes(ii,jj,:))));
            W_DUACS8g_HFRunfiltered_Corr_R(ii,jj) = abs(RR(1,2));
            W_DUACS8g_HFRunfiltered_Corr_angle(ii,jj) = angle(RR(1,2))*180/pi;
            RMSD_velmag_DUACS8g_HFRunfiltered(ii,jj) = rms( [Ug_DUACS8_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS8_HFRgrid_all(ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
            RMSDd_velmag_DUACS8g_HFRunfiltered(ii,jj) = rms_demeaned( [Ug_DUACS8_HFRgrid_all(ii,jj,:) + 1i*Vg_DUACS8_HFRgrid_all(ii,jj,:)] - ...
                                                          [U_rot_unfiltered_SWOTtimes(ii,jj,:) + 1i*V_rot_unfiltered_SWOTtimes(ii,jj,:)],'omitnan');
        else
        end
    end
    disp(100*ii/size(Ug_DUACS8_HFRgrid_all,1))
end
toc
...
save(['./CorrCoef_SWOT_HFRcartesian_quadfit_' num2str([2*PIXELS + 1]*2) 'kmBox.mat'],...
    ...
    'U_SWOTg_HFRunfiltered_Corr_R',...
    'U_SWOTg_HFRunfiltered_Corr_P',...
    'V_SWOTg_HFRunfiltered_Corr_R',...
    'V_SWOTg_HFRunfiltered_Corr_P',...
    'RMSD_velmag_SWOTg_HFRunfiltered',...
    'U_SWOTcg_HFRunfiltered_Corr_R',...
    'U_SWOTcg_HFRunfiltered_Corr_P',...
    'V_SWOTcg_HFRunfiltered_Corr_R',...
    'V_SWOTcg_HFRunfiltered_Corr_P',...
    'RMSD_velmag_SWOTcg_HFRunfiltered',...
    'PIXELS')
...
%% Map correlation (G,GC vs. filtered HFR)

close all
figure('Color','w')
tiledlayout(2,3,'TileSpacing','tight')

% Decide if you want to plot the RMSD of the demeaned quantity (true) or
% not (false):
RMSDd = true;
...
if ~RMSDd
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSD_velmag_SWOTg_HFR);
    TITLE_TEXT = 'RMS($\mathbf{u}_\mathrm{SWOT} - \mathbf{u}_{\mathrm{HFR}_\mathrm{L.P.}}$)';
else
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSDd_velmag_SWOTg_HFR);
    TITLE_TEXT = 'RMS($\mathbf{u''}_\mathrm{SWOT} - \mathbf{u''}_{\mathrm{HFR}_\mathrm{L.P.}}$)';
end
...
ylabel('Geostrophic vs. Low-pass HFR','Interpreter','latex')
...
% title(TITLE_TEXT)
ylabel('Cyclogeostrophic vs. Low-pass HFR','Interpreter','latex')
...
if ~RMSDd
    histogram(RMSD_velmag_SWOTg_HFR,[0:0.05:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTg_HFR,[0:0.05:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
...
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
if ~RMSDd
    histogram(RMSD_velmag_SWOTcg_HFR,[0:0.05:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTcg_HFR,[0:0.05:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_SWOTcg_HFR_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0] + [0 -0.4104 0 0])
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSD_velmag_SWOTg_HFR - RMSDd_velmag_SWOTg_HFR);
TITLE_TEXT = {'RMS($\mathbf{u}_\mathrm{SWOT} - \mathbf{u}_{\mathrm{HFR}_\mathrm{L.P.}}$) - ' ; ...
              'RMS($\mathbf{u''}_\mathrm{SWOT} - \mathbf{u''}_{\mathrm{HFR}_\mathrm{L.P.}}$)'};
% m_text(-122.5,41.63,'(a)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
CB.Label.FontSize = 16;
CB.Label.String = '';
CB.Position = [0.5482    0.4760    0.0185    0.3630];
title(TITLE_TEXT,'Interpreter','latex')
ylabel('Geostrophic vs. Low-pass HFR','Interpreter','latex')
colormap(turbo)
...
%% SAVE FIGURE (CorrCoef on Cartesian Grid)

% if ~RMSDd
%     figure(1)
%     exportgraphics(gcf,...
%     '../figures/draft/F_corrcoef_cartesian.pdf',...
%     'BackgroundColor','none','ContentType','vector')
%     disp(['Image saved'])
%     figure(2)
%     exportgraphics(gcf,...
%     '../figures/draft/F_corrcoef_cartesian_complex.pdf',...
%     'BackgroundColor','none','ContentType','vector')
%     disp(['Image saved'])
% else
%     figure(1)
%     exportgraphics(gcf,...
%     '../figures/draft/F_corrcoef_cartesian_demeaned.pdf',...
%     'BackgroundColor','none','ContentType','vector')
%     disp(['Image saved'])
% 
%     figure(2)
%     exportgraphics(gcf,...
%     '../figures/draft/F_corrcoef_cartesian_demeaned_complex.pdf',...
%     'BackgroundColor','none','ContentType','vector')
%     disp(['Image saved'])
% end

%% Map correlation (G,GC vs. unfiltered HFR)
...
if ~RMSDd
    ...
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSDd_velmag_SWOTg_HFRunfiltered);
    disp('using demeaned quantities for the RMSD')
end
m_text(-122.5,41.5,'(a)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
...
clim([0 1]*0.5)
% TITLE_TEXT = 'RMSE (Geostr. vs. HFR) (m/s)';
TITLE_TEXT = 'RMS($\mathbf{u}_\mathrm{SWOT} - \mathbf{u}_{\mathrm{HFR}_\mathrm{unfiltered}}$)';
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
ylabel('Geostrophic vs. Unfiltered HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_SWOTg_HFRunfiltered_Corr_R .* [U_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_SWOTg_HFRunfiltered_Corr_R .* [V_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
if ~RMSDd
    ...
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSDd_velmag_SWOTcg_HFRunfiltered);
end
m_text(-122.5,41.5,'(d)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
...
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% title(TITLE_TEXT)
ylabel('Cyclogeostrophic vs. Unfiltered HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_SWOTcg_HFRunfiltered_Corr_R .* [U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_SWOTcg_HFRunfiltered_Corr_R .* [V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTg_HFRunfiltered_Corr_R);% .* [U_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTg_HFRunfiltered_Corr_angle.*[W_SWOTg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTg_HFRunfiltered_Corr_R>=0.5]);% .* [V_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTcg_HFRunfiltered_Corr_R);% .* [U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTcg_HFRunfiltered_Corr_angle.*[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]);% .* [V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
axes('Position',INSET_POSITION)
if ~RMSDd
    histogram(RMSD_velmag_SWOTg_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTg_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0])
histogram(W_SWOTg_HFRunfiltered_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0])
histogram(W_SWOTg_HFRunfiltered_Corr_angle.*[W_SWOTg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTg_HFRunfiltered_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
if ~RMSDd
    histogram(RMSD_velmag_SWOTcg_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTcg_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_SWOTcg_HFRunfiltered_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_SWOTcg_HFRunfiltered_Corr_angle.*[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTcg_HFRunfiltered_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
% % % ^^^^^^^ COMPLEX CORRELATION AND ANGLE

%% SAVE FIGURE (CorrCoef on Cartesian Grid, UNFILTERED HFR)

if ~RMSDd
    figure(1)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_unfiltered_cartesian.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
    figure(2)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_unfiltered_cartesian_complex.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
else
    figure(1)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_unfiltered_cartesian_demeaned.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
    figure(2)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_unfiltered_cartesian_demeaned_complex.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
end

%% Change/Improvement from filtering HFR:
...
DeltaCorrCoefColorLim = [-1 1]*0.5;
DeltaRMSEColorLim = [-1 1]*0.1;
DeltaAngleColorLim = [-1 1]*30;
...
if ~RMSDd
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSD_velmag_SWOTg_HFR - RMSD_velmag_SWOTg_HFRunfiltered);
else
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSDd_velmag_SWOTg_HFR - RMSDd_velmag_SWOTg_HFRunfiltered);
end
m_text(-122.5,41.5,'(a)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
% CB = colorbar;
clim(DeltaRMSEColorLim)
% TITLE_TEXT = 'RMSE (Geostr. vs. HFR) (m/s)';
TITLE_TEXT = '$\Delta$RMSD';
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
ylabel({'(Geo. vs. HFR$_\mathrm{low-pass}$)' ; 'minus' ; ...
        '(Geo. vs. HFR$_\mathrm{unfiltered}$)'},'Interpreter','latex')
...
set(gca,'FontSize',16)
% CB = colorbar;
clim(DeltaCorrCoefColorLim)
% TITLE_TEXT = {['U (Geostr. vs. HFR): corr. coef. R'];['(where P<' num2str(P_threshold) ')']};
TITLE_TEXT = {['$\Delta C_{uu}$ where $P<$ ' num2str(P_threshold) '']};
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
...
clim(DeltaCorrCoefColorLim)
% TITLE_TEXT = {['V (Geostr. vs. HFR): corr. coef. R'];['(where P<' num2str(P_threshold) ')']};
TITLE_TEXT = {['$\Delta C_{vv}$ where $P<$ ' num2str(P_threshold) '']};
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
...
if ~RMSDd
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSD_velmag_SWOTcg_HFR - RMSD_velmag_SWOTcg_HFRunfiltered);
else
    m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                      RMSDd_velmag_SWOTcg_HFR - RMSDd_velmag_SWOTcg_HFRunfiltered);
end
m_text(-122.5,41.5,'(d)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
CB = colorbar; clim(DeltaRMSEColorLim)
% TITLE_TEXT = 'RMSE (CG vs. HFR) (m/s)';
CB.Label.String = 'm s$^{-1}$';
CB.Label.Interpreter = 'latex';
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% title(TITLE_TEXT)
ylabel({'(CG vs. HFR$_\mathrm{low-pass}$)' ; 'minus' ; ...
        '(CG vs. HFR$_\mathrm{unfiltered}$)'},'Interpreter','latex')
...
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
CB = colorbar; clim(DeltaCorrCoefColorLim)
% TITLE_TEXT = {['U (CG vs. HFR): corr. coef. R'];['(where P<' num2str(P_threshold) ')']};
CB.Label.String = ['Change in Correlation Coefficient'];
CB.Label.Interpreter = 'latex';
CB.Label.FontSize = 16; CB.Location = 'southoutside';
CB.Ticks = [DeltaCorrCoefColorLim(1):[diff(DeltaCorrCoefColorLim)/10]:DeltaCorrCoefColorLim(2)];
CB.Position = [0.4020    0.0724    0.4951    0.0125];
% title(TITLE_TEXT)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTg_HFR_Corr_R - W_SWOTg_HFRunfiltered_Corr_R);% .* [U_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  [W_SWOTg_HFR_Corr_angle.*[W_SWOTg_HFR_Corr_R>=0.5]./[W_SWOTg_HFR_Corr_R>=0.5]] - ...
                  [W_SWOTg_HFRunfiltered_Corr_angle.*[W_SWOTg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTg_HFRunfiltered_Corr_R>=0.5]]);% .* [V_SWOTg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
% CB = colorbar;
clim(DeltaAngleColorLim)
% TITLE_TEXT = {['V (Geostr. vs. HFR): corr. coef. R'];['(where P<' num2str(P_threshold) ')']};
TITLE_TEXT = {['$\Delta\theta_{ww}$']};
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTcg_HFR_Corr_R - W_SWOTcg_HFRunfiltered_Corr_R);% .* [U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[U_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  [W_SWOTcg_HFR_Corr_angle.*[W_SWOTcg_HFR_Corr_R>=0.5]./[W_SWOTcg_HFR_Corr_R>=0.5]] - ...
                  [W_SWOTcg_HFRunfiltered_Corr_angle.*[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]]);% .* [V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]./[V_SWOTcg_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
...
clim(DeltaAngleColorLim)
% TITLE_TEXT = {['V (CG vs. HFR): corr. coef. R'];['(where P<' num2str(P_threshold) ')']};
CB.Label.String = 'Change in Angle (degrees)';
CB.Label.Interpreter = 'latex';
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% CB.Ticks = [-180 -90 0 90 180];
CB.Ticks = [-180 -90 0 90 180]/6;
% title(TITLE_TEXT)
...
% INSET_POSITION = [0.2216    0.7926    0.1051    0.0717];
INSET_POSITION = [0.2357 0.7926 0.0980 0.0717];
axes('Position',INSET_POSITION)
if ~RMSDd
    histogram(RMSD_velmag_SWOTg_HFR - RMSD_velmag_SWOTg_HFRunfiltered,[-0.2:0.01:0.2],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTg_HFR - RMSDd_velmag_SWOTg_HFRunfiltered,[-0.2:0.01:0.2],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0])
histogram(W_SWOTg_HFR_Corr_R - W_SWOTg_HFRunfiltered_Corr_R,[-0.5:0.05:0.5],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0])
histogram([W_SWOTg_HFR_Corr_angle.*[W_SWOTg_HFR_Corr_R>=0.5]./[W_SWOTg_HFR_Corr_R>=0.5]] - ...
          [W_SWOTg_HFRunfiltered_Corr_angle.*[W_SWOTg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTg_HFRunfiltered_Corr_R>=0.5]],[-30:3:30],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180]/6)
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
if ~RMSDd
    histogram(RMSD_velmag_SWOTcg_HFR - RMSD_velmag_SWOTcg_HFRunfiltered,[-0.2:0.01:0.2],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
else
    histogram(RMSDd_velmag_SWOTcg_HFR - RMSDd_velmag_SWOTcg_HFRunfiltered,[-0.2:0.01:0.2],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
end
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_SWOTcg_HFR_Corr_R - W_SWOTcg_HFRunfiltered_Corr_R,[-0.5:0.05:0.5],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram([W_SWOTcg_HFR_Corr_angle.*[W_SWOTcg_HFR_Corr_R>=0.5]./[W_SWOTcg_HFR_Corr_R>=0.5]] - ... 
          [W_SWOTcg_HFRunfiltered_Corr_angle.*[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]./[W_SWOTcg_HFRunfiltered_Corr_R>=0.5]],[-30:3:30],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180]/6)
% % % ^^^^^^^ COMPLEX CORRELATION AND ANGLE

%% SAVE FIGURE (CorrCoef change from filtered to unfiltered)

if ~RMSDd
    figure(1)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_diff_cartesian.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
    figure(2)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_diff_cartesian_complex.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
else
    figure(1)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_diff_cartesian_demeaned.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
    figure(2)
    exportgraphics(gcf,...
    '../figures/draft/F_corrcoef_diff_cartesian_demeaned_complex.pdf',...
    'BackgroundColor','none','ContentType','vector')
    disp(['Image saved'])
end

%% Map correlation (DUACS vs. low-pass HFR)
...
clim([0 1]*0.5)
% TITLE_TEXT = 'RMSE (Geostr. vs. HFR) (m/s)';
TITLE_TEXT = 'RMS($\mathbf{u}_{\mathrm{DUACS}} - \mathbf{u}_{\mathrm{HFR}_\mathrm{Low-pass}}$)';
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
ylabel('DUACS 1/4$^\circ$ vs. Low-pass HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_DUACS4g_HFR_Corr_R .* [U_DUACS4g_HFR_Corr_P<P_threshold]./[U_DUACS4g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_DUACS4g_HFR_Corr_R .* [V_DUACS4g_HFR_Corr_P<P_threshold]./[V_DUACS4g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% title(TITLE_TEXT)
ylabel('DUACS 1/8$^\circ$ vs. Low-pass HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_DUACS8g_HFR_Corr_R .* [U_DUACS8g_HFR_Corr_P<P_threshold]./[U_DUACS8g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_DUACS8g_HFR_Corr_R .* [V_DUACS8g_HFR_Corr_P<P_threshold]./[V_DUACS8g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS4g_HFR_Corr_R);% .* [U_DUACS4g_HFR_Corr_P<P_threshold]./[U_DUACS4g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS4g_HFR_Corr_angle.*[W_DUACS4g_HFR_Corr_R>=0.5]./[W_DUACS4g_HFR_Corr_R>=0.5]);% .* [V_DUACS4g_HFR_Corr_P<P_threshold]./[V_DUACS4g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS8g_HFR_Corr_R);% .* [U_DUACS8g_HFR_Corr_P<P_threshold]./[U_DUACS8g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS8g_HFR_Corr_angle.*[W_DUACS8g_HFR_Corr_R>=0.5]./[W_DUACS8g_HFR_Corr_R>=0.5]);% .* [V_DUACS8g_HFR_Corr_P<P_threshold]./[V_DUACS8g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
INSET_POSITION = [0.2216    0.7926    0.1051    0.0717];
axes('Position',INSET_POSITION)
histogram(RMSD_velmag_DUACS4g_HFR,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0])
histogram(W_DUACS4g_HFR_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0])
histogram(W_DUACS4g_HFR_Corr_angle.*[W_DUACS4g_HFR_Corr_R>=0.5]./[W_DUACS4g_HFR_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
histogram(RMSD_velmag_DUACS8g_HFR,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_DUACS8g_HFR_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_DUACS8g_HFR_Corr_angle.*[W_DUACS8g_HFR_Corr_R>=0.5]./[W_DUACS8g_HFR_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
% % % ^^^^^^^ COMPLEX CORRELATION AND ANGLE

%% SAVE FIGURE (CorrCoef on Cartesian Grid, DUACS and FILTERED HFR)

% figure(1)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_DUACS_lowpass_cartesian.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])
% 
% figure(2)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_DUACS_lowpass_cartesian_complex.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])

%% MAP CORRELATION DIFFERENCE (of CorrCoef on Cartesian Grid, SWOT and FILTERED HFR versus DUACS and FILTERED HFR)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSDd_velmag_SWOTg_HFR - RMSD_velmag_DUACS4g_HFR);
m_text(-122.5,41.5,'(a)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
ylabel({'(SWOT Geostr. vs. Low-pass HFR)';'minus';'(DUACS 1/4$^\circ$ vs. Low-pass HFR)'},'Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSDd_velmag_SWOTg_HFR - RMSD_velmag_DUACS8g_HFR);
m_text(-122.5,41.5,'(d)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% title(TITLE_TEXT)
ylabel({'(SWOT Geostr. vs. Low-pass HFR)';'minus';'(DUACS 1/8$^\circ$ vs. Low-pass HFR)'},'Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTg_HFR_Corr_R - W_DUACS4g_HFR_Corr_R);% .* [U_DUACS4g_HFR_Corr_P<P_threshold]./[U_DUACS4g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_SWOTg_HFR_Corr_R - W_DUACS8g_HFR_Corr_R);% .* [U_DUACS8g_HFR_Corr_P<P_threshold]./[U_DUACS8g_HFR_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
INSET_POSITION = [0.2316    0.7926    0.1051    0.0717];
axes('Position',INSET_POSITION)
histogram(RMSDd_velmag_SWOTg_HFR - RMSD_velmag_DUACS4g_HFR,[-0.6:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.278 0 0 0])
histogram(W_SWOTg_HFR_Corr_R - W_DUACS4g_HFR_Corr_R,[-1:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.278 0 0 0])
histogram([W_SWOTg_HFR_Corr_angle.*[W_SWOTg_HFR_Corr_R>=0.5]./[W_SWOTg_HFR_Corr_R>=0.5]] - ...
          [W_DUACS4g_HFR_Corr_angle.*[W_DUACS4g_HFR_Corr_R>=0.5]./[W_DUACS4g_HFR_Corr_R>=0.5]],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
histogram(RMSDd_velmag_SWOTg_HFR - RMSD_velmag_DUACS8g_HFR,[-0.6:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.278 0 0 0] + [0 -0.4104 0 0])
histogram(W_SWOTg_HFR_Corr_R - W_DUACS8g_HFR_Corr_R,[-1:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.278 0 0 0] + [0 -0.4104 0 0])
histogram([W_SWOTg_HFR_Corr_angle.*[W_SWOTg_HFR_Corr_R>=0.5]./[W_SWOTg_HFR_Corr_R>=0.5]] - ...
          [W_DUACS8g_HFR_Corr_angle.*[W_DUACS8g_HFR_Corr_R>=0.5]./[W_DUACS8g_HFR_Corr_R>=0.5]],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
% % % ^^^^^^^ COMPLEX CORRELATION AND ANGLE
...
% figure(1)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_SWOT_DUACS_diff_lowpass_cartesian.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])
% 
% figure(2)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_SWOT_DUACS_diff_lowpass_cartesian_complex.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])

%% Map correlation (DUACS vs. unfiltered HFR)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSD_velmag_DUACS4g_HFRunfiltered);
m_text(-122.5,41.5,'(a)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
clim([0 1]*0.5)
% TITLE_TEXT = 'RMSE (Geostr. vs. HFR) (m/s)';
TITLE_TEXT = 'RMS($\mathbf{u}_{\mathrm{DUACS}} - \mathbf{u}_{\mathrm{HFR}_\mathrm{unfiltered}}$)';
% CB.Label.FontSize = 16;
title(TITLE_TEXT,'Interpreter','latex')
ylabel('DUACS 1/4$^\circ$ vs. Unfiltered HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_DUACS4g_HFRunfiltered_Corr_R .* [U_DUACS4g_HFRunfiltered_Corr_P<P_threshold]./[U_DUACS4g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_DUACS4g_HFRunfiltered_Corr_R .* [V_DUACS4g_HFRunfiltered_Corr_P<P_threshold]./[V_DUACS4g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  RMSD_velmag_DUACS8g_HFRunfiltered);
m_text(-122.5,41.5,'(d)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
CB.Label.FontSize = 16; CB.Location = 'southoutside';
% title(TITLE_TEXT)
ylabel('DUACS 1/8$^\circ$ vs. Unfiltered HFR','Interpreter','latex')
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  U_DUACS8g_HFRunfiltered_Corr_R .* [U_DUACS8g_HFRunfiltered_Corr_P<P_threshold]./[U_DUACS8g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  V_DUACS8g_HFRunfiltered_Corr_R .* [V_DUACS8g_HFRunfiltered_Corr_P<P_threshold]./[V_DUACS8g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.5,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS4g_HFRunfiltered_Corr_R);% .* [U_DUACS4g_HFRunfiltered_Corr_P<P_threshold]./[U_DUACS4g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(b)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS4g_HFRunfiltered_Corr_angle.*[W_DUACS4g_HFRunfiltered_Corr_R>=0.5]./[W_DUACS4g_HFRunfiltered_Corr_R>=0.5]);% .* [V_DUACS4g_HFRunfiltered_Corr_P<P_threshold]./[V_DUACS4g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(c)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS8g_HFRunfiltered_Corr_R);% .* [U_DUACS8g_HFRunfiltered_Corr_P<P_threshold]./[U_DUACS8g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(e)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
set(gcf,'color','w'); hold on
m_pcolor_centered(NORCAL.HFR.LON,NORCAL.HFR.LAT,...
                  W_DUACS8g_HFRunfiltered_Corr_angle.*[W_DUACS8g_HFRunfiltered_Corr_R>=0.5]./[W_DUACS8g_HFRunfiltered_Corr_R>=0.5]);% .* [V_DUACS8g_HFRunfiltered_Corr_P<P_threshold]./[V_DUACS8g_HFRunfiltered_Corr_P<P_threshold]);
m_text(-122.5,41.63,'(f)','Interpreter','latex','HorizontalAlignment','center','FontSize',20)
COAST = m_gshhs_i('patch',0.5*[1 1 1],'FaceAlpha',0.5);
m_grid('box','fancy', 'backgroundcolor','none');
set(gca,'FontSize',16)
...
INSET_POSITION = [0.2216    0.7926    0.1051    0.0717];
axes('Position',INSET_POSITION)
histogram(RMSD_velmag_DUACS4g_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0])
histogram(W_DUACS4g_HFRunfiltered_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0])
histogram(W_DUACS4g_HFRunfiltered_Corr_angle.*[W_DUACS4g_HFRunfiltered_Corr_R>=0.5]./[W_DUACS4g_HFRunfiltered_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
axes('Position',INSET_POSITION + [0 -0.4104 0 0])
histogram(RMSD_velmag_DUACS8g_HFRunfiltered,[0:0.06:0.6],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 1*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_DUACS8g_HFRunfiltered_Corr_R,[0:0.05:1],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
axes('Position',INSET_POSITION + 2*[0.2815 0 0 0] + [0 -0.4104 0 0])
histogram(W_DUACS8g_HFRunfiltered_Corr_angle.*[W_DUACS8g_HFRunfiltered_Corr_R>=0.5]./[W_DUACS8g_HFRunfiltered_Corr_R>=0.5],[-180:10:180],'Normalization','pdf','FaceColor',[1 1 1]*0.2); yticklabels([])
xticks([-180 -90 0 90 180])
% % % ^^^^^^^ COMPLEX CORRELATION AND ANGLE

%% SAVE FIGURE (CorrCoef on Cartesian Grid, DUACS and UNFILTERED HFR)

% figure(1)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_DUACS_unfiltered_cartesian.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])
% 
% figure(2)
% exportgraphics(gcf,...
% '../figures/draft/F_corrcoef_DUACS_unfiltered_cartesian_complex.pdf',...
% 'BackgroundColor','none','ContentType','vector')
% disp(['Image saved'])

%% Difference between SWOT/HFR and DUACS/HFR correlation (filtered HFR)
...
disp(['        5          10           25          50          75          90           95%ile'])
disp(['On SWOT grid:'])
disp(['U+iVg:  ' num2str(prctile(Collimate(std(U_geostr                 + 1i*V_geostr                ,0,3,'omitnan')),[5    10   25   50   75   90   95]))])
disp(['U+iVCg: ' num2str(prctile(Collimate(std(U_cyclogeostr_Nit        + 1i*V_cyclogeostr_Nit       ,0,3,'omitnan')),[5    10   25   50   75   90   95]))])
disp(['On HFR grid:'])
...
%%
%%
%% Discarded material that might need to be kept, just in case:
%% RMSD and correlation between geostrophic velocity to HFR velocity
